...
public class TinyDB {
    ...
    public ArrayList<ProdDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProdDomain> playerList =  new ArrayList<ProdDomain>();

        for(String jObjString : objStrings){
            ProdDomain player  = gson.fromJson(jObjString,  ProdDomain.class);
    ...
    public void putListObject(String key, ArrayList<ProdDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProdDomain player: playerList){
